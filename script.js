...
// Link da mídia para o easter egg
...
const CV_BASE64_DATA = "data:application/pdf;base64,SEU_CODIGO_BASE64_MUITO_LONGO_AQUI_PARA_PDF_OU_DOCX"; 
...
function downloadCV() {
    ...
    if (CV_BASE64_DATA.includes("SEU_CODIGO_BASE64_MUITO_LONGO_AQUI")) {
...
/**
 * Busca a cotação do Dólar, voltando até 7 dias (robusto contra feriados/fins de semana).
 */
...
function adicionarMensagemComDigitacao(remetente, resposta, classe, callback = () => {}) {
    ...
    function exibirProximoCaractere() {
        if (index < textoPuro.length) {
            ...
            const delay = remetente === "Product Manager GPT" ? 35 : 1
